...
Report PHP errors, exceptions and fatal shutdowns from WordPress to a LaravelMonitor server.

== Description ==

LaravelMonitor centralises errors from your sites. This plugin captures
...
* Initial release: global exception, error and fatal-shutdown capture forwarded
  to a LaravelMonitor server, with a wp-admin settings screen (server URL,
